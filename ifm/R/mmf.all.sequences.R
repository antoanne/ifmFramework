...
#' @param  in that position the id of MMF's predecessors.  For instance, in list(0,1,2,3,1,5,c(4,6)), we have for MMF 1, predecessor MMF 0; for MMF 2,
#' @param predecessor MMF 7, predecessors 4 and 6
#'
#' @description Generates the list of all possible MMF sequences (topsorts), constrained by the predecessors
#' 
