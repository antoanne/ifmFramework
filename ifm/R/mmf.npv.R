...
ex.mmf.df.1r <- mmf.df.1r(ex.mmf.seq, ex.mmf.sched, ex.mmf.npv.sum)

# TODO: Change mmf.max.npv to extract info from dataframe
ex.mmf.max.npv <- mmf.max.npv(ex.mmf.npv.sum, ex.mmf.seq, ex.mmf.sched)
ex.mmf.npv.max.sequence <- ex.mmf.max.npv[[1]]
ex.mmf.npv.max.sched <- ex.mmf.max.npv[[2]]
ex.mmf.npv.max.value <- ex.mmf.max.npv[[3]]
