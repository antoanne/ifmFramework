test.present.value <- function()
{
  ...
  npv <- net.present.value(c(-10000,2000,7000,11000), 4.5, TRUE)
  ...
  npv <- net.present.value(c(-243000,50000,50000,50000,50000,50000,50000,50000,50000,50000,50000,50000,50000), 1.0, TRUE)
  checkIdentical( round (npv, digits =1) ,319753.9  )
  print (round(npv, digits = 1))
  ...
  npv <- net.present.value(c(-8320,3411, 4070,5824,2965), 18.0, TRUE)
  ...
  checkIdentical( round (npv, digits =2),809.09)
  print (round(npv, digits = 2))
